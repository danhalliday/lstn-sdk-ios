        ...
        describe("player") {
            ...
            describe("callback interface") {
                ...
                it("calls back after loading a URL") {
                    ...
                    expect(result).toEventually(equal(true), timeout: 100)
            ...
            describe("delegate interface") {
                ...
                it("calls its delegate after loading a URL") {
                    ...
                    expect(spy.loadingDidStartFired).toEventually(equal(true), timeout: 100)
                    expect(spy.loadingDidFinishFired).toEventually(equal(true), timeout: 100)
