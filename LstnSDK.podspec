#
#  Be sure to run `pod spec lint LstnSDK.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Dan Halliday"
  # s.authors            = { "Dan Halliday" => "dan@danhalliday.com" }
  # s.social_media_url   = "http://twitter.com/Dan Halliday"
